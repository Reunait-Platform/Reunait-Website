...
function ChartLegendContent({
  ...
  nameKey,
    ...
    payload?: Array<{ type?: string; dataKey?: string; value?: number | string; color?: string }>
  ...
  return (
    ...
    >
      {payload
        ...
        .map((item: { type?: string; dataKey?: string; value?: number | string; color?: string }, index: number) => {
